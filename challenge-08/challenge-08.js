...
desses parâmetros.
*/
var sum = function calculateSum(argX, argY){
  return argX + argY;
};
...
- Essa função deve retornar uma segunda função que fará o seguinte:
  ...
  "Operação inválida."
*/
function calculator(argOperator){
  return function(valueX, valueY){
    var result;
    ...
    return 'Resultado da operação: '+ valueX +' '+ argOperator +' '+ valueY +' = '+ result +'.';
